 ...
 */
final class Version20210216164837 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE conference (id INT NOT NULL, city VARCHAR(255) NOT NULL, year INT NOT NULL, international BOOLEAN NOT NULL, PRIMARY KEY(id))');
